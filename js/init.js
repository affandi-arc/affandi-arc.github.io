...
------------------------------------------------------*/
   ...
   // $('form#contactForm button.submit').click(function send() {
   ...
   //    $.ajax({
	...
	//       type: "POST",
	//       url: "https://script.google.com/macros/s/AKfycbw1yELQYtvkrvKxIJWC20hQ51bUYS1Z96uPoGM0QpEL6pcKcplPXrvM6sorQntgSrP1MQ/exec",
	//       data: data,
